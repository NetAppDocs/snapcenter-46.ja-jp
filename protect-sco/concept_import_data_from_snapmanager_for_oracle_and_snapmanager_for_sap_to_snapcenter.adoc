...
SnapCenter Plug-in for Oracle Database でサポートされる構成をに示します https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["NetApp Interoperability Matrix Tool で確認できます"^]。
